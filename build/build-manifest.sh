...
docker manifest create -a piersfinlayson/build:${VERSION} piersfinlayson/build-amd64:${VERSION} piersfinlayson/build-armv7l:${VERSION}
...
docker manifest create -a piersfinlayson/build:latest piersfinlayson/build-amd64:${VERSION} piersfinlayson/build-armv7l:${VERSION}
